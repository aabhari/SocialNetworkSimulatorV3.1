...
public class UserGenSimAgent extends Agent 
{
	...
	protected void setup() 
	{
		...
		myGui.appendUserGenTweetsResult(getLocalName()+" numArtificialTweets: "+numArtificialTweets); // added by Sepide
	...
	private class UserGenSimBehaviour extends OneShotBehaviour {		
		...
		public void action() {	
			...
			for (int i = 0; i < kClusters; i++)
			{
				...
				myGui.appendUserGenTweetsResult("shuffled remainingUserNames: "+remainingUserNames);  // added by Sepide
				...
				myGui.appendUserGenTweetsResult("initialUserName: "+initialUserName);  // added by Sepide 
